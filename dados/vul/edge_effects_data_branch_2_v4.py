...
def vulnerability_node(graph, size):

    vul = {}
    eff_before = global_efficiency_local(graph, size)
    ...
    for node in graph.nodes:
        ...
        # getting efficency
        eff_after = global_efficiency_local(graph2, size - 1)
